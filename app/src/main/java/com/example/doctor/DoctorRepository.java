...
public class DoctorRepository {
    ...
    private void initData() {
        ...
        doctors.add(new Doctor(21, "Phạm Ngọc Anh", "TS. BS",
                "24 năm kinh nghiệm",
                ...
                "TS.BS Phạm Ngọc Anh 24 năm Phẫu thuật tổng quát. Chuyên phẫu thuật nội soi ổ bụng, cắt túi mật, cắt ruột thừa, thoát vị và các phẫu thuật tiêu hóa."));
